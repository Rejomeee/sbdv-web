...
class NetworkFailure with _$NetworkFailure {
  ...
  String get errorCaption => when(
        ...
        nullResponse: () =>
            "Constants.inboxPrint ? Strings.devErrorCaption : Strings.defaultErrorCaption",
        emptyList: () =>
            "Constants.inboxPrint ? Strings.devErrorCaption : Strings.defaultErrorCaption",
        notFound: (msg) =>
            "Constants.inboxPrint ? Strings.devErrorCaption : Strings.defaultErrorCaption",
        ...
        serverError: (msg) =>
            "Constants.inboxPrint ? Strings.devErrorCaption : Strings.defaultErrorCaption",
        channelNull: () =>
            "Constants.inboxPrint ? Strings.devErrorChannelUrlNull : Strings.defaultErrorCaption",
        connectionTimeout: () =>
            "Constants.inboxPrint ? Strings.devErrorConnection : Strings.defaultErrorCaption",
        receiveTimeout: (msg) => msg ?? "Strings.defaultErrorCaption",
        notAcceptable: () =>
            "Constants.inboxPrint ? Strings.dev406Error : Strings.defaultErrorCaption",
      );
  ...
  String get errorMessage => when(
        ...
        expected: () => '',
        unexpected: (msg) =>
            "Constants.inboxPrint ? msg : Strings.defaultErrorMessage",
        nullResponse: () =>
            "Constants.inboxPrint ? Strings.devErrorNullResp : Strings.defaultErrorMessage",
        serverError: (msg) =>
            "Constants.inboxPrint ? '$msg' : Strings.defaultErrorMessage",
        notFound: (msg) =>
            "Constants.inboxPrint ? '$msg' : Strings.defaultErrorMessage",
        emptyList: () =>
            "Constants.inboxPrint ? Strings.devErrorEmptyList : Strings.defaultErrorMessage",
