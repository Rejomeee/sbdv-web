  ...
  DataRow2 getRow(int index, [Color? color]) {
    ...
    return DataRow2.byIndex(
      ...
      color: color != null
          ...
          : (hasZebraStripes && index.isEven ? WidgetStateProperty.all(Theme.of(context).highlightColor) : null),
      ...
      cells: [
        ...
        DataCell(Text('${dessert.calories}'),
            onTap: () => _showSnackbar(context, 'Tapped on a cell with "${dessert.calories}"', Colors.red)),
